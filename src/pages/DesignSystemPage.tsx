 ...
 * Design System Page
 *
 * Internal UI component showcase for validating design tokens and primitives.
 */
import { Button, Input, Card, CardHeader, CardBody } from '@/components/ui';

export function DesignSystemPage() {
  return (
    <div data-testid="design-system-page" className="max-w-4xl space-y-6">
      <h1 className="text-2xl font-semibold text-text-primary">Design System</h1>
      <p className="text-text-secondary">
        UI primitives and tokens used throughout AV Designer.
      </p>
